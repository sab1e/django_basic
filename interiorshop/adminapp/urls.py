...
urlpatterns = [
    path('users/create/',
         ...
         name='user_create'),
    path('users/read/',
         adminapp.UsersListView.as_view(),
         name='users'),
    ...
    path('categories/read/',
         adminapp.ProductCategoriesListView.as_view(),
         name='categories'),
    path('categories/update/<int:pk>/',
         adminapp.ProductCategoryUpdateView.as_view(),
         name='category_update'),
    path('categories/delete/<int:pk>/',
         adminapp.ProductCategoryDeleteView.as_view(),
    ...
    path('products/read/category/<int:pk>/',
         adminapp.ProductsListView.as_view(),
         name='products'),
